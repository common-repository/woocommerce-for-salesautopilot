...
class SalesAutopilotAPI
{
	 ...
	 * @param string $api_username   Your MailChimp API username
	 * @param string $api_password   Your MailChimp API password
	 */
	 ...
	 * @return array|bool     Assoc array of decoded result or false if no result.
	 */
